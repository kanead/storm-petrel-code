...
Alltracks <- Alltracks[Alltracks$location=="ireland",]
...
# remove the 0s
which(Alltracks$Latitude==0)
Alltracks<-Alltracks[Alltracks$Latitude!=0 & Alltracks$Longitude!=0, ]
which(Alltracks$Latitude==0)
...
LAEAproj = CRS('+proj=laea +lat_0=53 +lon_0=-10 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84  +units=m +no_defs')
...
# remove wrong relocation
Alltracks<-Alltracks[Alltracks$Latitude < 150000, ]
plot(Alltracks$Longitude, Alltracks$Latitude)
...
longlatproj =CRS('+proj=longlat +lat_0=53 +lon_0=-10 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84  +units=m +no_defs')
