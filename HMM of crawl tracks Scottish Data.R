###################################################################################
# Storm Petrel Movement Code - Scottish Data
###################################################################################
...
# prep the data for a HMM
stormData <- momentuHMM::prepData(stormData)

# find locations within certain lat/lon distance in r, distance is given in metres 
# location of Mousa
mylat <- 60
mylon <- -1.166667
lat<-stormData$lat
